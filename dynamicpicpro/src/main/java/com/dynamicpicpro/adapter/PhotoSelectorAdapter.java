...
import com.dynamicpicpro.R;

import java.util.ArrayList;

/**
 * 作者：DC-ZhuSuiBo on 2018/4/2 0002 10:44
 * 邮箱：suibozhu@139.com
 */

public class PhotoSelectorAdapter extends com.dynamicpicpro.adapter.MBaseAdapter<PhotoModel> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (position == 0 && StringUtils.isNull(models.get(position).getOriginalPath())) { // 当时第一个时，显示按钮
            if (convertView == null || !(convertView instanceof TextView)) {
                tvCamera = (TextView) LayoutInflater.from(context).inflate(R.layout.view_camera_pro, null);
