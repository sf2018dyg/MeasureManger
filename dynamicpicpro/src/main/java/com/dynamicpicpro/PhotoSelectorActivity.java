...
/**
 * 作者：DC-ZhuSuiBo on 2018/4/2 0002 11:25
 * 邮箱：suibozhu@139.com
 */
...
import com.dynamicpicpro.adapter.AlbumAdapter;
import com.dynamicpicpro.adapter.PhotoSelectorAdapter;
...
import com.dynamicpicpro.util.AnimationUtil;
import com.dynamicpicpro.util.CommonUtils;
import com.dynamicpicpro.util.FileUtils;
import com.dynamicpicpro.util.ImageUtils;
import com.dynamicpicpro.util.StringUtils;
import com.dynamicpicpro.view.SelectPhotoItem;
...
public class PhotoSelectorActivity extends Activity implements SelectPhotoItem.onItemClickListener, SelectPhotoItem.onPhotoItemCheckedListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DisplayImageOptions defaultDisplayImageOptions = new DisplayImageOptions.Builder() //
                ...
                .resetViewBeforeLoading() // 载入之前重置ImageView
                ...
                .build(); //
        ImageLoaderConfiguration config = new ImageLoaderConfiguration.Builder(PhotoSelectorActivity.this)
                .defaultDisplayImageOptions(defaultDisplayImageOptions).memoryCacheExtraOptions(480, 800)
                .threadPoolSize(5).build();
        ImageLoader.getInstance().init(config);
        photoSelectorDomain = new PhotoSelectorDomain(PhotoSelectorActivity.this);
        ...
        photoAdapter = new PhotoSelectorAdapter(PhotoSelectorActivity.this, new ArrayList<PhotoModel>(),
                CommonUtils.getWidthPixels(this), this, this, this, limit);
        gvPhotos.setAdapter(photoAdapter);
        albumAdapter = new AlbumAdapter(PhotoSelectorActivity.this, new ArrayList<AlbumModel>());
    ...
    private void catchPicture() {
        ...
        Uri uri = FileProvider.getUriForFile(PhotoSelectorActivity.this, PhotoSelectorActivity.this.getApplicationContext().getPackageName() + ".provider", new File(
    ...
    private void popAlbum() {
        ...
        new AnimationUtil(PhotoSelectorActivity.this, R.anim.translate_up_current).setLinearInterpolator().startAnimation(
                layoutAlbum);
    }
    ...
    private void hideAlbum() {
        new AnimationUtil(PhotoSelectorActivity.this, R.anim.translate_down).setLinearInterpolator().startAnimation(
                layoutAlbum);
