 ...
 * 已评价Fragment
 */
public class Evaluated_CustomersToMeFragment extends BaseFragment<Evaluate_CustomersToMePresenter> implements IEvaluate_CustomerToMeView {
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()){
                ...
                case R.id.llfItem:
                    ...
                    intent2.putExtra("Evaluate_CustomersToMeBean", etmList.get(pos));
    ...
    public void RefreshData(boolean isRefresh) {
        ...
        presenter.getY_EvaluatedList(1);
    }

    @Override
    protected void loadmoredata() {
        if (pageTurnBean!=null && pageTurnBean.getPageCount() > pageTurnBean.getPageNo()) {
            presenter.getY_EvaluatedList( pageTurnBean.getPageNo()+1);
        } else {
            finishRefresh();
    ...
    @Override
    public void showYList(boolean isSuccess, PageTurnBean pt, List<Evaluate_CustomersToMeBean> beans, String msg) {
        if (isSuccess) {
            if (pt != null) {
                if (pt.getPageNo() <= 1) {
    ...
    @Override
    public void showNList(boolean isSuccess, PageTurnBean pageBean, List<Evaluate_CustomersToMeBean> beans, String msg) {
