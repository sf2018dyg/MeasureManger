 ...
 * 邮箱：suibozhu@139.com
 */
public class LiangChiListAdapter extends BaseAdapter<LiangChiListAdapter.ViewHolder, LiangChiBean> {

    private List<LiangChiBean> list;
    private static LiangChiMainActivity mainActivity;
    static View.OnClickListener listener;

    public LiangChiListAdapter(Context context, LiangChiMainActivity mainActivity, List<LiangChiBean> list, View.OnClickListener listener) {
        super(context);
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(mInflater.inflate(R.layout.adapter_liangchi, parent, false));
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.querenyuyue.setTag(position);
