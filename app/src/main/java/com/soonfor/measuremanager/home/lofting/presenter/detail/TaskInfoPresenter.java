...
public class TaskInfoPresenter implements IBasePresenter, AsyncUtils.AsyncCallback {
    ...
    public void getPargress(TaskProgress progress) {
        bgFragment.setProgressImage(AppCache.getProgressListData(progress, "A08"));
    }
    ...
    public void acceptTask(String taskno) {
        Request.acceptTask(bgFragment.getContext(), this, PreferenceUtil.getCurrentUserBean().getSalesId(), "mark", taskno);
    }
