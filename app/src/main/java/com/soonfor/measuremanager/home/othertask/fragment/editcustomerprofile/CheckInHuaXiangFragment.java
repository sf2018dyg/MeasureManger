 ...
 * 类用途：
 */
public class CheckInHuaXiangFragment extends BaseFragment<EditCustomerProfilePresenter> {
    ...
    public static CheckInHuaXiangFragment newInstance(String customerId) {
        Bundle args = new Bundle();
        args.putString("customerId", customerId);
        CheckInHuaXiangFragment fragment = new CheckInHuaXiangFragment();
    ...
    protected void initViews() {
        ...
        //从草稿中恢复
        try {
            tmpBeans = Hawk.get("CheckInCustomerProfileBean", null);
            if (tmpBeans != null) {
        ...
        runnable = new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Hawk.put("CheckInCustomerProfileBean", tmpBeans);
