...
class JGActionFrame extends LinearLayout {
    ...
    private View createShareboardLayout(List<SnsPlatform> platforms) {
        ...
        if(viewPager != null) {
            ...
            //NLogger.e("UMActionFrame","viewpager is null");
        }
    ...
    private ViewPager createViewPagerInstance() {
        ...
        try {
            ...
            NLogger.e("JGActionFrame","JGActionFrame create ViewPager Instance error:" + var6);
            return viewPager;
        }
    }
    ...
    private boolean verifyMethodExists() {
        try {
            ...
            NLogger.e("JGActionFrame","JGActionFrame verifyMethodExists addOnPageChangeListener error:" + var3);
        }
