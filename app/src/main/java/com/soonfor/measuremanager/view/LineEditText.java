...
public class LineEditText extends EditText implements TextWatcher, View.OnFocusChangeListener {
    ...
    private int focusedDrawableId = R.drawable.login_username_focus;// 默认的
    private int unfocusedDrawableId = R.drawable.login_username;
    private int errorDrawableId = R.drawable.login_username;
    Drawable left = null;
...
//        focusedDrawableId = a.getResourceId(R.styleable.lineEdittext_drawableFocus, R.drawable.login_username_focus);
//        unfocusedDrawableId = a.getResourceId(R.styleable.lineEdittext_drawableUnFocus, R.drawable.login_username);
//        errorDrawableId = a.getResourceId(R.styleable.lineEdittext_drawableError, R.drawable.login_username);
//        a.recycle();
        init();
    }
    ...
    private void init() {
        ...
        setStatus(status);
        del_btn = mContext.getResources().getDrawable(R.drawable.ic_delete_input);
        del_btn_down = mContext.getResources().getDrawable(R.drawable.ic_delete_input);
        addListeners();
