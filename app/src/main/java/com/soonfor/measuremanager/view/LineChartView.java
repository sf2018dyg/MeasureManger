...
public class LineChartView extends View {
    ...
    private int topSpace, bottomSpace = 0;
    private int tablePadding;
    private int tablePaddingDP = 0;//view四周padding默认dp
    ...
    private int lineColor = Color.parseColor("#ffffff");//曲线颜色
    private float lineWidthDP = 0.5f;//曲线宽度dp

    private int pointColor = Color.parseColor("#e1e1e1");//锚点颜色
    ...
    private int pointTextColor = Color.parseColor("#e1e1e1");//锚点文本颜色
