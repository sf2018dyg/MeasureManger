package com.soonfor.measuremanager.view.stepview;
...
public class HorizontalStepsViewIndicator extends View {
    ...
    private int mUnCompletedLineColor = Color.RED;//定义默认未完成线的颜色  definition ContextCompat.getColor(getContext(), R.color.uncompleted_color);
    ...
    private void init() {
        ...
        mDefaultIcon = ContextCompat.getDrawable(getContext(), R.drawable.flow_fail);//未完成的icon
        mLastIcon = ContextCompat.getDrawable(getContext(), R.drawable.default_icon);
    }
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mCircleCenterPointPositionList.size(); i++) {
            ...
            if (stepsBean.getState() == StepBean.STEP_UNDO) {
                ...
                mLastIcon.setBounds(rect);
                mLastIcon.draw(canvas);
            }
        }
        //-----------------------画图标-----draw icon-----------------------------------------------
    }
