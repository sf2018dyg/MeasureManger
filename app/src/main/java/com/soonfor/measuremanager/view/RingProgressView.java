...
public class RingProgressView  extends View {
    ...
    public RingProgressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        currentProgress = typedArray.getFloat(R.styleable.RingProgressView_currentProgress, currentProgress);
        maxProgress = typedArray.getColor(R.styleable.RingProgressView_maxProgress, (int) maxProgress);
        typedArray.recycle();
