...
import com.soonfor.measuremanager.view.Timepicker.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private static final int[] SHADOWS_COLORS = new int[] { 0xeeffffff, 0xeaffffff, 0x22ffffff };
	...
	/**
	 * Gets view me_evaluate_ranking
	 *
	 * @return the view me_evaluate_ranking
	 */
	...
	/**
	 * Sets view me_evaluate_ranking. Usually new adapters contain different views, so it
	 * needs to rebuild view by calling measure().
	 *
	 * @param viewAdapter
	 *            the view me_evaluate_ranking
	 */
