...
/**
 * 作者：DC-ZhuSuiBo on 2018/8/1 0001 08:29
 * 邮箱：suibozhu@139.com
 * 类用途：增加自定义的drawable单击事件
 */
...
//        	throw new NullPointerException("You can add drawableRight attribute in XML");
            mClearDrawable = getResources().getDrawable(R.mipmap.empty);
        }
        mClearDrawable.setBounds(0, 0, mClearDrawable.getIntrinsicWidth(), mClearDrawable.getIntrinsicHeight());

        //左边的放大镜
        mLookDrawable = getCompoundDrawables()[0];
        if (mLookDrawable == null) {
            mLookDrawable = getResources().getDrawable(R.mipmap.search2);
        }
