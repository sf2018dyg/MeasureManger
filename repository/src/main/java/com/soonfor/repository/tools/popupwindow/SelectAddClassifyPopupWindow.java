...
import com.soonfor.repository.adapter.knowledge.add.FirstClassifyAdapter;
...
public class SelectAddClassifyPopupWindow extends PopupWindow {
    ...
    public SelectAddClassifyPopupWindow(final Activity context, CategoryBean[] cbs, ImageView imgfCover, refresh refreshInterface) {
        mActivity = context;
        ...
        flcAdapter = new FirstClassifyAdapter(mActivity, DataTools.fTypes, cbs[0], cbs[1], rvfSecondLevl, refreshInterface);
        // 设置布局管理器
...
//        });
    ...
    public interface refresh{
        void refreshLayout(CategoryBean[] cbs);
    }
}
